<System.ComponentModel.RunInstaller(True)> Partial Class ProjectInstaller
    ...
    Private Sub InitializeComponent()
        ...
        'ServiceInstaller
        '
        Me.ServiceInstaller.Description = "Supports  local Proxy DSS Publications data distribution "
        Me.ServiceInstaller.DisplayName = "SvMet DSS Publications Proxy Server"
        Me.ServiceInstaller.ServiceName = "SvMet_DSS_Publications_Proxy_Server"
        '
        'ProjectInstaller
        '
