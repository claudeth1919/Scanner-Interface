<System.ComponentModel.RunInstaller(True)> Partial Class ProjectInstaller
    ...
    Private Sub InitializeComponent()
        ...
        'ServiceInstaller
        '
        Me.ServiceInstaller.Description = "Serves Data contained in Data Publications to connected clients"
        Me.ServiceInstaller.DisplayName = "STZ Data Socket Server"
        Me.ServiceInstaller.ServiceName = "STZ_DS_Server"
        '
        'ProjectInstaller
        '
