<System.ComponentModel.RunInstaller(True)> Partial Class ProjectInstaller
    ...
    Private Sub InitializeComponent()
        ...
        'ServiceInstaller
        '
        Me.ServiceInstaller.Description = "Maintains a network directory of components that shares data as peers"
        Me.ServiceInstaller.DisplayName = "STZ Component Network Directory Server"
        Me.ServiceInstaller.ServiceName = "STZ_CND_Server"
        '
        'ProjectInstaller
        '
